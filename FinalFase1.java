...
public class FinalFase1 {

    private Window janela;
    private GameImage credito;
    private Keyboard teclado;

    public FinalFase1(Window window) {
        janela = window;
    ...
    private void escreveTexto() {
        ...
        String frase1 = "Ruim :2";
        String frase2 = "Mal :3";
        String frase3 = "Bom :3";
        String frase4 = "Otimo :0";
        String frase5 = "Nível de Parkour : Mal ;(";
        String frase6 = "Não desista, continue praticando.";
        String frase7 = "";
        String frase8 = "";
